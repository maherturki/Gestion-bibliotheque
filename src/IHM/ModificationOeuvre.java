...
public ModificationOeuvre(Frame parent, boolean modal) {
    ...
    public ModificationOeuvre(Frame parent, boolean modal, Oeuvre oeuvre) {
        this(parent, modal);
    ...
    private void initComponents() {
        ...
        annulerBouton.setFont(new Font("Tahoma", 1, 13)); // NOI18N
        ...
        modifierBouton.setFont(new Font("Tahoma", 1, 13)); // NOI18N
