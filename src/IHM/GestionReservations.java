...
public class GestionReservations extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new Font("Tahoma", 3, 18)); // NOI18N
        ...
        nomUsagerLabel.setFont(new Font("Tahoma", 1, 14)); // NOI18N
        nomUsagerLabel.setText("-");

        identifiantUsagerCombo.setFont(new Font("Tahoma", 1, 14)); // NOI18N
        ...
        validerBouton.setFont(new Font("Tahoma", 1, 14)); // NOI18N
