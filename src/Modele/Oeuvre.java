...
public class Oeuvre {
    ...
    private boolean oeuvreExiste(Oeuvre oeuvre) throws BibalExceptions {
        ...
        Stream<Oeuvre> filterOeuvre = oeuvres.stream().filter((oeuvre1) -> (oeuvre.getTitre().equals(oeuvre1.getTitre())
    ...
    // + " ORDER BY e.id)";
    // ArrayList<Oeuvre> oeuvres = find(SQL_SELECT_OEUVRE_SANS_EXEMP, new
    // Object[0]);
    // if (oeuvres.isEmpty()) {
    // return false;
    // }
    ...
    public String toString() {
        return "id=" + id + ", titre=" + titre + ", auteur=" + auteur + ", categorie=" + categorie + ", nbResa="
                + nbResa + " ";
    }
